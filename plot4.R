...
with(DTderiv,plot(DateTime,Voltage,type="l",xlab="datetime",ylab="Voltage"))
...
plot(DTderiv$DateTime,DTderiv$Global_reactive_power, type="l",xlab="datetime",ylab="Global_Reactive_Power")
dev.off()
